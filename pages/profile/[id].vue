        ...
        <div class="pt-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 pr-2 w-[calc(100%-90px)] max-w-[1800px] 2xl:mx-auto">
            <div class="flex w-[calc(100vw-230px)]">
                ...
                <div class="ml-5 w-full">
                    ...
                    <button
                        v-else
                        class="flex items-center rounded-md py-1.5 px-8 mt-3 text-[15px] font-semibold bg-[#f02c56]"
                    >
                        Follow
                    </button>
                </div>
            ...
            <div class="flex items-cetner pt-4">
                <div class="mr-4">
            ...
            <div class="pt-4 mr-4 text-gray-500 font-light text-[15px] max-w-[500px]">
            ...
            <div class="mt-4 grid 2xl:grid-cols-6 xl:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-3">
                <PostUser />
                <PostUser />
                <PostUser />
                <PostUser />

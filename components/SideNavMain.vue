    ...
    >
        <div class="lg:w-full w-[55px] mx-auto">
            ...
            <div class="lg:block hidden text-[11px] text-gray-500">
                <div class="pt-4 px-2">About the Newsroom by tenance</div>
                <div class="pt-4 px-2">Tiktok for good advertisement developers transparency rewards browse tiktok</div>
                <div class="pt-4 px-2">Helps teerms and conditions privacy creator portal community guidelines</div>
